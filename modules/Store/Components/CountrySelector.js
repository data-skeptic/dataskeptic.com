...
export default class CountrySelector extends Component {
    ...
    renderOption = (country, i) => {
        const key = country.short + "_" + i
        return <option key={key} value={country.short}>{country.long}</option>
    }
    ...
    render() {
        return (
            <Field name="country" component="select" onChange={this.change}>
                <option />
                {countries.map(this.renderOption)}
            </Field>
        )
    }
}
