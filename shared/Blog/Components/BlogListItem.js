...
class BlogListItem extends Component {
    ...
    render() {
        ...
        const summaryClasses = preview ? 'col-xs-12 col-sm-9 col-md-9 blog-summary' : 'col-xs-12 col-sm-12 col-md-12 blog-summary'
        return (
            <div className="row blog-list-item" key={blog.uri}>
                {preview && <div className="col-xs-12 col-sm-3 col-md-3 blog-preview">
