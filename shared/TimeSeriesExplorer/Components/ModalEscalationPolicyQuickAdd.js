  ...
  render() {
    ...
    return (
      <div className="modal-escalation-policy-quick-add-inner">
        <p>
          Fill in only the services you want. Multiple services is permitted.
        </p>
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-xs-10">
            <input onChange={this.handleChange.bind(this, 'sms')} value={sms} />
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-xs-10">
            <input
              onChange={this.handleChange.bind(this, 'voice_call')}
              value={voice_call}
            />
          </div>
        </div>
