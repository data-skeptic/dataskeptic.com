...
class AlertsAdd extends React.Component {
  ...
  handleEscalationPolicyPicked(selectedOption) {
    var dispatch = this.props.dispatch
    dispatch({
      type: 'TSE_SET_ESCALATION_POLICY',
  ...
  render() {
      ...
      return (
        <div className="row">
          <div className="col-sm-8">
            <p>You don't have any escalation policies set up yet.</p>
          </div>
          <div className="col-sm-4">
            <button
              className="escalation-quick-add"
    ...
    return (
      <div className="time-series-alerts">
        ...
        <div className="row">
          <div className="col-xs-12 col-sm-2">Escalation Policy:</div>
        ...
        <div className="row">
          <div className="col-xs-12">
            <button
              ...
              onClick={this.handleAlertSave.bind(this)}
            >
              Save
            </button>
          </div>
