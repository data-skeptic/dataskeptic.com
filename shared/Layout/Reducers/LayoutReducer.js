...
import {TOGGLE_MOBILE_MENU, CHANGE_PAGE_TITLE, TOGGLE_SEARCH_AREA} from '../Actions/LayoutActions';
...
export default function LayoutReducer(state = defaultState, action) {
    ...
    switch (type) {
        ...
        case TOGGLE_SEARCH_AREA:
            state = state.setIn(['searchAreaVisible'], !state.get('searchAreaVisible'));
            return state;
