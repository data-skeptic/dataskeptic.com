...
export function loadProducts(env, my_cache) {
    ...
    axios
        ...
        .then(function(result) {
            ...
            delete my_cache.products['items'];
    ...
    .then(function(result) {
        ...
        parser.parseString(xml, function(err,rss) {
            ...
            for (var i=0; i < episodes.length; i++) {
                ...
                // delete my_cache.episodes_map[guid];
                my_cache.episodes_map[guid] = episode
                if (i == 0) {
                    delete my_cache.episodes_map["latest"];
            ...
            delete my_cache.episodes_list;
            my_cache.episodes_list = [];
