    ...
    <div className="comment-type-selector">
        <div className="btn-group btn-group-justified" role="group">
            <div className="btn-group" role="group">
                <div type="button" className={classNames("btn btn-default btn-type", {'active': active === TEXT})} onClick={(e) => onChoose(TEXT, e)}>
            ...
            <div className="btn-group" role="group">
                <div type="button" className={classNames("btn btn-default btn-type", {'active': active === UPLOAD})} onClick={(e) => onChoose(UPLOAD, e)}>
                    <div className="description">
                        <div className="description">
            ...
            <div className="btn-group" role="group">
                <div type="button" className={classNames("btn btn-default btn-type", {'active': active === RECORDING})} onClick={(e) => onChoose(RECORDING, e)}>
                    <div className="description">
