        ...
        return (
            <div className="recorder-container">
                <section className={`test-buttons`}>
                    ...
                    <button type="button" onClick={() => this.goTo('INIT')}>INIT</button>
                    <button type="button" onClick={() => this.goTo('LOADING')}>LOADING</button>
                    <button type="button" onClick={() => this.goTo('RECORDING')}>RECORDING</button>
                    <button type="button" onClick={() => this.goTo('VIEW_RECORD')}>VIEW_RECORD</button>
                ...
                <Wizard activeKey={activeStep}>
                    ...
                    <ReviewRecord key={`VIEW_RECORD`} isPaying={isPaying} togglePaying={this.togglePaying}/>
                </Wizard>
            </div>
        );
    }
