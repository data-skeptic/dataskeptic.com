    ...
    return (
      <div className="cms-admin-container">
        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-10">
            <input
              ...
              onChange={this.update.bind(this, me, 'title')}
              value={title}
            />
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-10">
            <textarea
              className="cms-abstract-textarea"
              onChange={this.update.bind(this, me, 'abstract')}
              value={abstract}
            />
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-2">
            <input
              onChange={this.update.bind(this, me, 'author')}
              value={author}
            />
          </div>
          ...
          <div className="col-xs-12 col-sm-6">
            <input
              className="cms-publish-date-input"
              onChange={this.update.bind(this, me, 'publish_date')}
              value={publish_date}
            />
          </div>
        </div>
        <div className="row">
          <div className="col-xs-12 col-sm-2" />
          <div className="col-xs-12 col-sm-5 cms-admin-save-btn">
            <button
          ...
          <div className="col-xs-12 col-sm-5 cms-admin-save-btn">
            <button
              className="cms-btn-save"
              onClick={this.delete.bind(this, blog_id, dispatch)}
            >
              Delete
            </button>
          </div>
