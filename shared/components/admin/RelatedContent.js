        ...
        <div className="center">
          <div className="row">
            ...
            <div className="col-xs-9">
              <BlogSearchSelect id="source" onChange={this.changeBlog} />
          ...
          <div className="row">
            ...
            <div className="col-xs-9">
              {this.state.type === 'internal-link' ? (
                <BlogSearchSelect id="dest" onChange={this.changeBlog} />
              ) : (
                <input
                  onChange={this.update.bind(this, me, 'dest')}
          ...
          <div className="row">
            ...
            <div className="col-xs-9">
              <input
                onChange={this.update.bind(this, me, 'body')}
