				...
				<div className="row projects-container">
					<div className="col-xs-12 col-sm-6">
						<div className="project-box">
							<div className="project-img-container"><img className="project-img" src="/img/png/openhouse.png" /></div>
					...
					<div className="col-xs-12 col-sm-6">
						<div className="project-box">
							<div className="project-img-container"><img className="project-img" src="/img/png/snl-impact.png" /></div>
