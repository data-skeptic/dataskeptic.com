        ...
        <div className="coaching-inner">
          <div className="membership-bottom-container">
            <div className="membership-price">
              $275.00<span className="per_month">/ month</span>
            </div>
            <div className="coaching-desc">
              <p>
                We'll coordinate a set time every other week to meet on Skype
                for a one hour session structured in a way that most benefits
...
export default page(connect(state => ({ products: state.products }))(
  CoachingBiWeekly
), { title: 'Professional development coaching'})
