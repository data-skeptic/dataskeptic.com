	...
	render() {
		return (
			<div className="center">
				...
				<p>My services include a weekly 1 hour Skype session where we define your goals, discuss your questions, and I share relevant knowledge, contacts, and references.  With most of the people I work with, this means technical walkthroughs where I teach them tools like SQL, sk-learn, dplyr, Spark, etc.  Other times we focus more on interview preparation or portfolio building.  Basically, I'm here to develop a custom plan that works for you.</p>
				<p>In addition to our hour weekly checkin, I'm happy to have some email back and forth or a Slack discussion when we're both online.  We'll usually set goals in each Skype session, so this is helpful if there are stumbling blocks along the way and we don't lose a week.</p>
				<p>Overall, my vision is to help you find a career you want to pursue, identify any skill gaps, teach those skill gaps, and coach you through rounds of interviews until you have an offer letter in your hand.  I can often make personal introductions when I have relevant industry contacts.</p>
