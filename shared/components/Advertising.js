	...
	render() {
		return (
			<div className="center">
				...
				<ul>
					<li className="adv-li"><b>Data Skeptic is the top 5% of all podcasts</b> as evidenced by the growing 25k weekly downloads by unique subscribers.</li>
					<li className="adv-li">To put that into perspective, <b>21% of the USA market listens to podcasts</b>; which is <a target="_blank" href="http://www.convinceandconvert.com/social-media-measurement/the-5-key-2016-podcast-statistics/">equal to the percentage of people who use Twitter (in the USA)</a>.</li>
					<li className="adv-li"><b>Our listeners discovered Data Skeptic organically</b>.  More than 45% of listeners organically found us on iTunes, Stitcher or some other podcast discovery software.</li>
					<li className="adv-li"><b>Podcast listeners are 19% more likely to follow brands compared to Social media users.</b></li>
					<li className="adv-li">73% of podcast listeners, hear the podcast episode within 48 hours of downloading it; that is <a target="_blank" href="http://www.edisonresearch.com/wp-content/uploads/2016/05/The-Podcast-Consumer-2016.pdf">immediate engagement</a>.</li>
					<li className="adv-li"><b>We're influential and growing.</b>  Kyle Polich, as the Data Skeptic has spoken at high-profile events including IBM Insights, Big Data Day LA, and the Dallas Data Science conference.</li>
				</ul>
