    ...
    if (products_loaded == 0) {
      ...
      return (
        <div className="center">
          ...
          <p>
            Your membership supports Data Skeptic's ability to continue
            delivering quality content on a weekly basis and expand into new
            mediums. For $1 per episode, your contributions can help us launch
            more projects and continuously improve the content of the podcast.
          </p>
          <div>
            <h3>Donations</h3>
            <p>
              If you prefer to make a one time contribution, you can do so via
                      ...
                      <div className="membership-bottom-container">
                        ...
                        <div className="membership-btn">
                          <button
                            ...
                            onClick={me.addToCart.bind(me, product)}
                          >
                            Add to Cart
                          </button>
                          <p>or</p>
                          ...
                          >
                            ...
                            <input
                              type="submit"
                              className="membership-add-paypal"
                              value="Subscribe with Paypal"
                            />
                            <img
                              alt=""
                              border="0"
