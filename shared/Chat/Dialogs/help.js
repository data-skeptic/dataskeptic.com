...
var help_menu = [
  {
    label: 'episode recommendations',
    handler: episode.handler,
    get_opening_remark: episode.get_opening_remark
  },
  {
    label: 'listener survey',
    handler: survey.handler,
    get_opening_remark: survey.get_opening_remark
  },
  {
    label: 'store',
    handler: store.handler,
    get_opening_remark: store.get_opening_remark
  },
  {
    label: 'profiles',
    handler: profiles.handler,
    get_opening_remark: profiles.get_opening_remark
  }
]
...
function handler(dispatch, reply, cstate, message) {
  ...
  var msg =
    "I didn't understand you.  Please try again or say 'exit' to give up on help."
