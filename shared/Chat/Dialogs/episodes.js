...
function no_results_handler(dispatch, reply, cstate, message) {
  var msg =
    "I can't think of an episode related to that.  Suggest something else or type 'exit'"
...
module.exports = {
  ...
  get_opening_remark,
  can_handle,
  make_recommendation_handler,
  verify_payload_is_blog,
  recommendation_action_handler,
  no_results_handler
}
